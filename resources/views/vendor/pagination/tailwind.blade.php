        ...
        <div>
            <span class="inline-flex relative z-0 rounded-md shadow-sm">
                ...
                <span aria-current="page">
                    <span
                        class="inline-flex relative items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-white bg-green-800 border border-gray-300 cursor-default">{{ $page }}</span>
                </span>
                @else
                <a href="{{ $url }}"
