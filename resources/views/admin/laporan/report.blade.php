<x-app-layout>
    ...
    <div id="div1" class="inline-flex overflow-hidden mb-2 w-full bg-white  shadow-md">
        <div class="flex justify-center items-center w-1 bg-green-800">
        </div>
                ...
                <table class="border w-full mb-2 mt-2">
                    <thead>
                        <tr class=" text-xs uppercase">
                            ...
                            <th class=" px-2 border ">KLs</th>
                            <th class=" px-2 text-right">Keterangan</th>
                            <th class=" px-2 text-left">Alasan</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($liskelassantri as $kelassantri)
