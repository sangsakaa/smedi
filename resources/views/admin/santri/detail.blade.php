<x-app-layout>
    ...
    <div class="inline-flex overflow-hidden mb-2 w-full bg-white  shadow-lg">
        <div class="flex justify-center items-center w-1  bg-green-800">
        </div>
        <div class=" grid grid-cols-1 sm:grid-cols-2 py-2 gap-2 px-4 ">
            <div>
                <a href="/histori/{{$santri->id}}">
                    <button class=" px-4 py-1 bg-red-800 rounded-md text-white">Histori Pendaftaran</button>
                </a>
                <a href="/historipelanggaran/{{$santri->id}}">
                    <button class=" px-4 py-1 bg-blue-800 rounded-md text-white">Histori Pelanggaran</button>
                </a>
            </div>
        </div>
    </div>
