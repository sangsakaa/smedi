            ...
            <div class=" bg-white  shadow-xs">
                <div class=" bg-gray-50 ">
                    <div class="overflow-hidden mb-2 w-full  border shadow-xs">
                        <div class="overflow-x-auto w-full">
                            <div class=" w-full px-2 grid grid-cols-2  ">
                                <div class=" py-1 font-semibold  text-green-800">
                                    <a href="/santri/create"><button class="px-2 py-1 inline-block bg-green-800  text-white rounded-md"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="  inline-block bi bi-person-plus-fill" viewBox="0 0 16 16">
                                        ...
                                        <td class=" grid px-1 py-1 text-sm justify-items-center">
                                            <div class=" flex  text-center ">
                                                <form action="/santri/{{$s->id}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit" class=" text-green-800" onclick="return confirm (' Apakah Anda Ingin Menghapus Data ini : {{$s->nama_santri}}')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" text-center bi bi-trash text-red-600" viewBox="0 0 16 16">
                                                            <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                                                            <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" />
                                                        </svg></button>
                                                </form>
                                                <a href="/santri/{{$s->id}}/edit" onclick="return confirm (' Apakah Anda Ingin Mengubah Data ini : {{$s->nama_santri}}')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" inline-block bi bi-pencil-square text-green-800 " viewBox="0 0 16 16">
                        ...
                        <div class=" text-center px-1 py-1 text-xs font-semibold tracking-wide text-gray-500 bg-gray-50 border-t
                                                ">
                            {{ $listSantri->links() }}
                        </div>
                    </div>
