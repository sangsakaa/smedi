<x-app-layout>
        ...
        <div type="text" class=" w-full grid grid-cols-2 bg-white rounded-lg shadow-xs px-4 py-2 ">
            ...
            <div class=" grid justify-items-end">
                <form action="/absen" method="get">
                    <input type="date" name="cari" value="{{ request('cari') }}" class="border border-green-800 text-green-800 rounded-md py-1 px-4" placeholder=" Cari ..">
        ...
        <div class=" sm:w-1/2 w-full px-4 py-1">
            <form action="/absen" method="post">
                ...
                <div class=" w-full grid sm:grid-cols-3 grid-cols-1 gap-2">
                    <input class=" border border-green-600 rounded-md px-2 py-1" placeholder=" masukan data" type="date" name="tgl">
    ...
    <div class="inline-flex overflow-hidden mb-1 mt-1 w-full bg-white rounded-lg shadow-md">
        ...
        <div class=" w-full px-4">
            ...
            @endif
            @if (session('succes'))
            <div class=" w-1/2 bg-green-200 px-2 py-1 capitalize alert-dismissible fade show" role="alert" type="button">
                {{session('succes')}}
            </div>
            @endif
                    ...
                    <tr class=" hover:bg-gray-100">
                        ...
                        <td class=" border   ">
                            ...
                            <div class="  text-center ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-  text-center inline-block  text-red-600" viewBox="0 0 16 16">
                            ...
                            @else
                            <div class=" text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-square text-green-600  inline-block text-center" viewBox="0 0 16 16">
