                ...
                <div class=" grid grid-cols-2 gap-2">
                    ...
                    <div class=" grid justify-items-end">
                        <form action="/kelas" method="get">
                            <select name="cari" value="{{ request('cari') }}" class="border border-green-800 text-green-800 rounded-md py-1 px-4">
            ...
            <div class="mx-3">
                <div class=" bg-white rounded-lg shadow-xs">
                    <form action="/kelas" method="post">
                        @csrf
                        <input name="nama_kelas" type="text" class=" border border-green-800 w-1/4 rounded-md px-2 py-1" placeholder=" masukan nama Kelas">
                                                ...
                                                <div class=" flex">
                                                    <div class="flex">
                                                        <form action="/kelas/{{$kelas->id}}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit" class=" text-green-800" onclick="return confirm (' Apakah Anda Ingin Menghapus Kelas : {{$kelas->nama_kelas}} ')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                                    ...
                                                    <div class=" flex">
                                                        <a href="/kelas/{{$kelas->id}}/edit" onclick="return confirm (' Apakah Anda Ingin Merubah Kelas : {{$kelas->nama_kelas}} ')">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square ml-1 text-green-800 " viewBox="0 0 16 16">
