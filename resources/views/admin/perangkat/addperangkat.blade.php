    ...
    <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md">
        ...
        <div class="px-4 py-2 w-full">
            <form action="/perangkat" method="post">
                ...
                <input name="nama_perangkat" type="text"
                    class="  text-green-800 border border-green-800 py-1 px-2 w-1/4  rounded-md"
                    placeholder=" Masuk nama Lengkap " value="{{old('nama_ustadz')}}" required>
                <div class=" w-full flex">
                    <label for="" class=" mr-2"> Jenis Kelamin</label>
                </div>
                <select name="jenis_kelamin" id=""
                    class="  text-green-800 border border-green-800 py-1 px-2 w-1/4 rounded-md  " required>
                ...
                <select name="agama" id="" class="  text-green-800 border border-green-800 py-1 px-2 w-1/4 rounded-md"
                    required>
                ...
                <div class=" w-full flex">
                    <button class=" mt-1  bg-green-800 py-1 px-2 w-1/4 d-block  mb-2 text-white rounded-md">
                        Simpan
                    </button>
                </div>
