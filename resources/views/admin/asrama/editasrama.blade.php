    ...
    <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md">
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3 font-semibold uppercase text-purple-600">
                Daftar List Santri <a href="#"><button class=" bg-purple-600 px-2 py-1 text-white rounded-md"><svg
                ...
                <div class=" bg-white rounded-lg shadow-xs">
                    <form action="/asrama/{{$asrama->id}}" method="post">
                        ...
                        <input value="{{ $asrama->nama_asrama}}" name="nama_asrama" type="text"
                            class=" rounded-md py-1 px-4" placeholder=" nama_asrama ">
                        <input value="{{ $asrama->kuota_asrama}}" name="kuota_asrama" type="text"
                            class=" rounded-md py-1 px-4" placeholder=" kuota_asrama ">
                        <select name="type_asrama" id="" class=" py-1 px-4  rounded-md">
