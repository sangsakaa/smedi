<x-app-layout>
  ...
  <div class="inline-flex overflow-hidden mb-1 mt-2 w-full bg-white  shadow-md">
  ...
  <div class="inline-flex overflow-hidden  w-full bg-white  shadow-md">
    ...
    <div class=" w-full px-2 py-2 ">
      <div class=" w-full ">
        <div class=" w-full bg-white  shadow-xs">
          <form action="/asramasantri" method="post">
            @csrf
            <div class=" w-full gap-2  grid grid-cols-4">
              <input autofocus name="santri_id" class=" border-green-800 form-control  py-1 px-2 rounded-md  border"
              ...
              <input name="asrama_id" type="hidden" value="{{$asrama->id}}" class="border-green-800 rounded-md py-1"
                placeholder=" asrama_id">
              <input name="histori_id" type="hidden" value="1" class=" px-4 border border-green-800 rounded-md py-1"
                placeholder=" histori_id">
              <input name="tanggal_masuk" type="date" value="1" class=" px-4 border border-green-800 rounded-md py-1"
                placeholder=" tanggal_masuk">
              <input name="tanggal_keluar" type="date" value="1" class=" px-4 border border-green-800 rounded-md py-1"
            ...
            <div class="overflow-x-auto w-full">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y">
                    ...
                    <td class="px-2 border py-1  text-sm flex  content-center ">
                      ...
                      <a href="/asramasantri/{{$item->id}}/edit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                          class="  bi bi-pencil-square text-green-800 " viewBox="0 0 16 16">
                          <path
                  ...
                  @endforeach
                  @else
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500  bg-gray-50 border-b">
