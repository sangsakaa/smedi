    ...
    <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md">
        ...
        <div class="px-4 py-2 w-full">
            <form action="/ustadz/{{$ustadz->id}}" method="post">
                ...
                <input name="nama_ustadz" type="text" class=" border border-green-800 py-1 px-2 w-1/4  rounded-md"
                    placeholder=" Masuk nama Lengkap " value="{{$ustadz->nama_ustadz}}" required>
                <div class=" w-full flex">
                    <label for="" class=" mr-2"> Jenis Kelamin</label>
                </div>
                <select name="jenis_kelamin" id="" class=" border border-green-800 py-1 px-2 w-1/4 rounded-md  "
                    required>
                ...
                <select name="agama" id="" class=" border border-green-800 py-1 px-2 w-1/4 rounded-md" required>
                ...
                <input name="tempat_lahir" type="text" class=" border border-green-800 py-1 px-2 w-1/4 rounded-md"
                ...
                <input value="{{$ustadz->tanggal_lahir}}" name="tanggal_lahir" type="date"
                    class=" border border-green-800 py-1 px-2 w-1/4  rounded-md" placeholder=" Masuk tempat lahir "
                    required>
                <div class=" w-full flex">
                ...
                <input value="{{$ustadz->no_hp}}" name="no_hp" type="text"
                    class=" border border-green-800 py-1 px-2 w-1/4  rounded-md" placeholder=" Nomor Hp / WhatApp ">

                <div class=" w-full flex">
                    <label for="" class=" mr-2"> Nama Bank</label>
                </div>
                <select name="nama_bank" id="" class=" border border-green-800 py-1 px-2 w-1/4 rounded-md  " required>
                ...
                <input value="{{$ustadz->no_rekening}}" name="no_rekening" type="text"
                    class=" border border-green-800 py-1 px-2 w-1/4  rounded-md" placeholder=" Nomor Rekning ">
                <div class=" w-full flex">
